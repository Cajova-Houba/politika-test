...
@ContextConfiguration(
    locations={"classpath:/applicationContext-Politika-resources.xml",
               "classpath:/applicationContext-Politika-jpa.xml"})
@Transactional
public abstract class BaseDaoTestCase {

	/**
	 * Name of the entity manager factory bean located in 
	 * applicationContext-Politika-jpa.xml
	 */
	private final String ENTITY_MANAGER_FACTORY = "entityManagerFactoryPolitika"; 
