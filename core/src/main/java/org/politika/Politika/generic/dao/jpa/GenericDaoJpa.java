...
public class GenericDaoJpa<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    /**
     * Name of the persistence unit located in resources/META-INF/persistence-Politika.xml
     */
    public static final String PERSISTENCE_UNIT_NAME = "ApplicationEntityManagerPolitika";
